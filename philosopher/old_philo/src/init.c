...
/*   Updated: 2023/05/13 06:35:09 by sooyang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_table(t_table *table, int argc, char **argv)
{
	...
	table->time_to_die = (long long)ft_atoi(argv[2]);
	table->time_to_eat = (long long)ft_atoi(argv[3]);
	table->time_to_sleep = (long long)ft_atoi(argv[4]);
	if (argv[5])
